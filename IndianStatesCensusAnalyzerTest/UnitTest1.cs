...
namespace IndianStatesCensusAnalyzerTest
{
    public class Tests
    {
        ...
        // CSV File paths
        string stateCensusPath = @"C:\Users\lavanya.g\source\repos\IndianStateCensusAnalyzer\IndianStateCensusAnalyzer\CSVFiles\IndiaStateCensusData.csv";
        string wrongCensusPath = @"C:\Users\lavanya.g\source\repos\IndianStateCensusAnalyzer\IndianStateCensusAnalyzer\CSVFiles\IndiaStateData.csv";
        string wrongTypeStateCensusPath = @"C:\Users\lavanya.g\source\repos\IndianStateCensusAnalyzer\IndianStateCensusAnalyzer\CSVFiles\IndiaStateCensusData.txt";
        string wrongHeaderStateCensusPath = @"C:\Users\lavanya.g\source\repos\IndianStateCensusAnalyzer\IndianStateCensusAnalyzer\CSVFiles\WrongIndiaStateCensusData.csv";
        string delimiterStateCensusPath = @"C:\Users\lavanya.g\source\repos\IndianStateCensusAnalyzer\IndianStateCensusAnalyzer\CSVFiles\DelimiterStateCensusData.csv";

        //State Code Header
        string stateCodeHeaders = "SrNo,State Name,TIN,StateCode";
        // CSV File paths
        string stateCodePath = @"C:\Users\lavanya.g\source\repos\IndianStateCensusAnalyzer\IndianStateCensusAnalyzer\CSVFiles\IndiaStateCode.csv";
        string wrongCodePath = @"C:\Users\lavanya.g\source\repos\IndianStateCensusAnalyzer\IndianStateCensusAnalyzer\CSVFiles\IndiaStateCodeData.csv";
        string wrongTypeStateCodePath = @"C:\Users\lavanya.g\source\repos\IndianStateCensusAnalyzer\IndianStateCensusAnalyzer\CSVFiles\IndiaStateCode.txt";
        string wrongHeaderStateCodePath = @"C:\Users\lavanya.g\source\repos\IndianStateCensusAnalyzer\IndianStateCensusAnalyzer\CSVFiles\WrongIndiaStateCode.csv";
        string delimiterStateCodePath = @"C:\Users\lavanya.g\source\repos\IndianStateCensusAnalyzer\IndianStateCensusAnalyzer\CSVFiles\DelimiterStateCode.csv";
